            ...
            <form action="/handleRegister" method="post">
                <div class="mb-4">
                    ...
                    <input
                        ...
                        name="name" id="name" type="text" placeholder="Dilshoda">
                </div>
                <div class="mb-6">
                    <label class="block text-gray-700 font-semibold mb-2" for="email">Email</label>
                    <input
                        class="appearance-none border rounded-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="email" id="email" type="email" placeholder="dil@gmail.com">
                </div>
                <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="/login"
                        class="text-blue-500 font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Login</a>
                </div>
            </form>
        </div>
    </div>
